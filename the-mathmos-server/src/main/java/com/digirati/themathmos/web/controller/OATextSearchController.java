...
public class OATextSearchController {
	...
	@Autowired
	public OATextSearchController(TextSearchService textSearchService,
	...
	public ResponseEntity<Map<String, Object>> searchTextOAGet(
		...
		ServiceResponse<Map<String, Object>> serviceResponse = textSearchService.getTextPositions(query, queryString,
				false, page, false, null, widthHeight);
	...
	public ResponseEntity<Map<String, Object>> searchTextWithinOAGet(@PathVariable String withinId,
		...
		ServiceResponse<Map<String, Object>> serviceResponse = textSearchService.getTextPositions(query, queryString,
				false, page, false, within, widthHeight);
	...
	public ResponseEntity<Map<String, Object>> autocompleteTextOAGet(
		...
		ServiceResponse<Map<String, Object>> serviceResponse = annotationAutocompleteService.getTerms(query, min,
