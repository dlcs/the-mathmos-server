...
public class OAAnnotationSearchController {
	...
	@Autowired
	public OAAnnotationSearchController(OAAnnotationSearchService oaAnnotationSearchService,
	...
	public ResponseEntity<Map<String, Object>> searchOAGet(
		...
		ServiceResponse<Map<String, Object>> serviceResponse = oaAnnotationSearchService
		...
		if (serviceResponseStatus.equals(Status.NOT_FOUND)) {
			Map<String, Object> emptyMap = annotationUtils.returnEmptyResultSet(queryString, false,
	...
	public ResponseEntity<Map<String, Object>> autocompleteGet(
		...
		ServiceResponse<Map<String, Object>> serviceResponse = annotationAutocompleteService.getTerms(query, motivation,
				date, user, min, queryString, false, null);
	...
	public ResponseEntity<Map<String, Object>> autocompleteWithinGet(@PathVariable String withinId,
		...
		ServiceResponse<Map<String, Object>> serviceResponse = annotationAutocompleteService.getTerms(query, motivation,
				date, user, min, queryString, false, within);
