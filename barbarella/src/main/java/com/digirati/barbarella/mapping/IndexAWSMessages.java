...
public class IndexAWSMessages {
    ...
    private static final Logger LOGGER = Logger.getLogger(IndexAWSMessages.class);
	...
	LOGGER.info(String.format("Initialising classpath XML application with [%s]", XML_APPLICATION_CONTEXT));
